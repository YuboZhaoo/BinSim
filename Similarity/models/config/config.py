...
def update_config_dataset_infer(config_dict, inputdir, outputdir, featuresdir, feature_json_name):
    """Config for Dataset-RTOS."""
    inputdir = os.path.join(inputdir, "Dataset-1")
    config_dict['testing'] = dict(
        infer_tasks=[
...
def update_config_dataset_apps(config_dict, inputdir, outputdir, featuresdir, feature_json_name):
    """Config for Dataset-RTOS."""
    inputdir = os.path.join(inputdir, "apps")
    config_dict['testing'] = dict(
        infer_tasks=[
            (
                os.path.join(inputdir, "testing_apps.csv"),
                os.path.join(outputdir, "testing_apps.pkl"),
            )
        ],
        features_testing_path=os.path.join(
            featuresdir, 'apps_testing',
            feature_json_name)
    )
...
def update_config(config_dict, args):
    if args.dataset == 'one':
        ...
        update_config_datasetrtos(
            config_dict, args.inputdir, args.outputdir, args.featuresdir, args.feature_json_name)
    elif args.dataset == 'pdg':
        update_config_datasetone(
            config_dict, args.inputdir, args.outputdir, args.featuresdir, args.feature_json_name)
    elif args.dataset == 'lddg':
        update_config_datasetone(
            config_dict, args.inputdir, args.outputdir, args.featuresdir, args.feature_json_name)
    elif args.dataset == 'ddg':
        update_config_datasetone(
            config_dict, args.inputdir, args.outputdir, args.featuresdir, args.feature_json_name)
    elif args.dataset == 'infer':
        update_config_dataset_infer(
            config_dict, args.inputdir, args.outputdir, args.featuresdir, args.feature_json_name)
    elif args.dataset == 'apps':
        update_config_dataset_apps(
            config_dict, args.inputdir, args.outputdir, args.featuresdir, args.feature_json_name)
    elif args.dataset == 'ddg_op':
        update_config_datasetone(
            config_dict, args.inputdir, args.outputdir, args.featuresdir, args.feature_json_name)
