...
from core.ggnn import *
from core.gtcn import *

from core.aggrs import *
from core.encoder import *

from core.loss import pairwise_loss
from core.loss import triplet_loss
from core.similarities import (
...
class GNNModel:
    ...
    def model_train(self, restore=None):
        ...
        # batch_inputs = self._nlp_encoder(batch_inputs, batch_features)
        ...
        while epoch_counter < self._config['training']['num_epochs']:
            ...
            '''
            '''
            # for next_batch_inputs, labels, batch_features in training_batch_generator:
            for next_batch_inputs, labels in training_batch_generator:
                ...
                0908
                '''
                # next_batch_inputs = self._nlp_encoder(next_batch_inputs, batch_features)
