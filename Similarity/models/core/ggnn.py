...
class GGNN(torch.nn.Module):
    ...
    def forward(self, x, edge_index, edge_feat, graph_idx, batch_size: int):
        # print("why")
        # contains_one = torch.any(edge_feat == 1)
        # print(contains_one)  # 如果包含 1，则输出 True，否则输出 False
        # contains_zero = torch.any(edge_feat == 0)
        # print(contains_zero)  # 如果包含 1，则输出 True，否则输出 False

        x, e = self.encoder(x, edge_feat, graph_idx)
        # unique_values, counts = torch.unique(e, dim=0, return_counts=True)
        #
        # # 打印结果
        ...
        #
        #
        # edge_type_0_indices = torch.nonzero(edge_feat == 0, as_tuple=True)[0]
        # edge_type_1_indices = torch.nonzero(edge_feat == 1, as_tuple=True)[0]
        # print("ghidra")
        # print(edge_feat[edge_type_0_indices[0]])
        # print(edge_feat[edge_type_1_indices[0]])
        # # 移除 as_tuple=True 参数
        ...
        # print("\n\n")
        # print(edge_index)
        # print(edge_type_0_indices)
        # print(edge_type_1_indices)
        # print("flag")
        # print("\n\n")
